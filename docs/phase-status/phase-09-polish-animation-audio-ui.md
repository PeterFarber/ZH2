...
- [ ] Editor Client Preview and client-flow authoring panels exist; Client Flow authoring validates screen/background/offline scene paths and Project panel opens RML/RCSS source files; manual UX polish and broader interaction validation remain.
