...
- [x] Project browser exposes `data/ui`, classifies RML/RCSS/client-flow assets, opens RML/RCSS files through the OS default handler, and opens client-flow assets into the authoring panel.
